...
double rec_dTmdlna(double xe, double Tm, double Tr, double H, double fHe, double fsR, double meR, double z_in, double logfz, double tau);
...
void rec_get_xe_next1_H(REC_COSMOPARAMS *param, double z_in, double xe_in, double Tm_in, double *xe_out,
                        ...
                        double **Dfnu_hist, double *dxedlna_prev, double *dxedlna_prev2, int *post_saha, LOGFZ_DATA *logfzdata);
